    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locked_by', models.CharField(choices=[('web', 'Сессия начата на сайте'), ('tg', 'Сессия начата в боте')], default='web', help_text="Кто в настоящий момент 'держит' сессию (web/telegram)", max_length=32)),
