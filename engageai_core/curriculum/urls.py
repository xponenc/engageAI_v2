...
from curriculum.views.learning_session_views import (
    LearningSessionView, LearningSessionTaskView,
    LessonHistoryView, CourseHistoryView, SubmitTaskResponseView
)
...
urlpatterns = [
    ...
    path('session/<int:enrollment_id>/submit/', SubmitTaskResponseView.as_view(), name='submit_task_response'),
